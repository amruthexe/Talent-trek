        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2 space-y-8">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-lg text-gray-700">
              Learn Ethical Hacking, Network Security, SOC operations, and more.
            </p>
            <p className="text-lg text-gray-700">
              Hands-on labs, real-world tools, and career-ready skills.
            </p>
            ...
            <p className="text-md text-gray-700">
              Certification + Practical Projects + Placement Assistance included.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-start">
            ...
            >
              <Link href="https://wa.me/919848814614?text=Hi%2C%20I'm%20interested%20in%20learning%20about%20your%20Cyber%20Security%20course.">
