      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 min-h-[400px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-6 md:p-8 lg:p-12 flex items-center">
          <div className="max-w-md lg:max-w-xl">
            ...
            <p className="mt-4 text-base md:text-lg text-gray-300 mb-8">
              A dual-paced, intensive 5-month program combining 2 full tech courses, project-based learning, 2 internships, and certified soft skills training. Get certified by AWS, Talent Trek, AICTE, and mentors from top MNCs.
            </p>
        ...
        <div className="p-6 md:p-8 lg:p-12 flex flex-col justify-center items-start text-white">
          ...
          <ul className="space-y-3 text-base md:text-lg">
            ...
            <li className="flex items-start sm:items-center"><CheckCircle className="text-green-500 mr-2 mt-1 sm:mt-0" /> Course Completion Certificate from Talent Trek & AICTE</li>
