...
export default function CloudComputingPromo() {
    ...
    <main className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2 space-y-8">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-lg text-gray-700">
              Master AWS, Azure, Google Cloud, DevOps, Containers & more.
            </p>
            <p className="text-lg text-gray-700">
              Hands-on labs, real projects, and certification guidance included.
            </p>
            ...
            <p className="text-md text-gray-700">
              Certification + Live Projects + Placement Assistance included.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-start">
            ...
            >
              <Link href="https://wa.me/919848814614?text=Hi%2C%20I'm%20interested%20in%20learning%20about%20your%20Cloud%20Computing%20course.">
        ...
        <div className="relative w-full lg:w-1/2">
          ...
          >
            <img
              src="/html.jpeg" // Replace with /cloud.jpeg if you have one
              alt="Cloud Computing Course Demo"
            ...
            <div className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-70 flex justify-center items-center z-50 p-4">
              <div className="relative w-full max-w-3xl aspect-[16/9]">
                <video
                  ...
                  autoPlay
                >
                  <source src="/html.mp4" type="video/mp4" /> {/* Replace with cloud.mp4 */}
