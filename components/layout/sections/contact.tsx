      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p className="mb-8 text-muted-foreground lg:w-5/6">
            At Talent Trek E-Learning, we are committed to helping learners upskill with high-quality, industry-relevant education. Reach out to us for any queries regarding our programs or enrollment.
          </p>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <div>324, 7th Cross, 7th Main, BTM 2nd Stage, Bangalore, Karnataka – 560076</div>
            </div>
