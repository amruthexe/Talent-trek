...
const Reviews = () => {
    return (
        <div className="flex flex-col items-center justify-center  md:py-16   w-full">
            <Container>
                <div className="flex flex-col items-center text-center max-w-xl mx-auto">
                    <h2 className="text-3xl md:text-4xl lg:text-4xl font-headingn font-bold  !leading-snug mt-6">
